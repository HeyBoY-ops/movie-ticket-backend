...
async function run() {
  for (const t of titles) {
    ...
    if (t === 'Gadar 2') title = 'Gadar 2';
    if (t === 'Rocky Aur Rani Kii Prem Kahaani') title = 'Rocky Aur Rani Kii Prem Kahaani';
    if (t === 'Pathaan') title = 'Pathaan';
    if (t === 'Jawan') title = 'Jawan (film)';
    try {
